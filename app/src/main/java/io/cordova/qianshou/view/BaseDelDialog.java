...
public class BaseDelDialog {
    ...
    public BaseDelDialog(Context mContext, View parentView) {
    ...
    public BaseDelDialog setBindClickListener(BindClickListener mBindClickListener) {
    ...
    private void initView() {
        mView = View.inflate(mContext, R.layout.del_friend_dailog, null);
        ...
        editText = (TextView) mView.findViewById(R.id.et_money);
