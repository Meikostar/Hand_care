...
import io.cordova.qianshou.mvp.adapter.RecordItemAdapter;
import io.cordova.qianshou.mvp.adapter.RemindItemAdapter;
import io.cordova.qianshou.mvp.adapter.UsePlanAdapter;
import io.cordova.qianshou.mvp.adapter.UseTimeAdapter;
...
public class UsePlanRecycleAdapter extends BaseRecycleViewAdapter {
   ...
   private List<Item> data=new ArrayList<>();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holders, final int position) {
        ...
        holder.tvTime.setText(TimeUtil.formatToMDs(list.date));
